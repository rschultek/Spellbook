...
export default function LanguageFilter({ initialLanguage = "All" }: Props) {
  ...
  return (
    <select
      ...
      className="pl-4 pr-10 py-2 border border-input rounded-md appearance-none bg-card text-card-foreground cursor-pointer focus:ring-1 focus:ring-ring focus:border-ring"
      style={{
